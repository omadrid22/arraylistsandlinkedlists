...
public class MyArrayList<T> {
	 ...
	 */
	public int size() {
		return size(initialLength); // FIXME
	}
	...
	public T get(int index) {
		String element = MyArrayList.get(index);
	...
	public void remove(int index) {
		String element = MyArrayList.remove(index);
	}
	 ...
	 */
	private void resize() {
		Object[] Array2 = new Object[MyArrayList.length * 2];
	}
